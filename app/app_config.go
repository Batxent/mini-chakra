...
import (
	...
	tokenfactorymodulev1 "mini-chakra/api/minichakra/tokenfactory/module"
	_ "mini-chakra/x/tokenfactory/module" // import for side-effects
	tokenfactorymoduletypes "mini-chakra/x/tokenfactory/types"
